...
<script type="text/javascript">
	function add(form) {
		...
		/* 	$.post("${pageContext.request.contextPath}/UserRegist",$(form).serialize(),
		 function(data){
		 alert("大大大实打实大撒");
		 if(data=='ok'){
		 alert("客户添加成功！");
	...
	<div class="container"
		...
		<div class="row">
			...
			<div class="col-md-8"
				...
				<!-- <form class="form-horizontal" style="margin-top: 5px;" action=""
					method="post" onsubmit="return add(this)"> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<input type="text" class="form-control" id="inputPassword3"
								placeholder="请输入验证码"> <input type="hidden"
								name="verCode" value="${verCode}">
						</div>
						<div class="col-sm-3">
