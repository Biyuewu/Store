...
INSERT INTO `category` VALUES ('33576EC05AB4458B988E36420CA5A7D4', '测试添加');
...
-- ----------------------------
INSERT INTO `orderitem` VALUES ('09F3917B03B843E6A941284AC73BC1E2', '1', '2298', '11', 'E0B88054A28541F5B34997583ADCF3B7');
INSERT INTO `orderitem` VALUES ('3A41E828C4354E47BC06A24A0D9F6BAE', '1', '2298', '11', '608C0D09185B4B3D8F7E6B7850B7B489');
INSERT INTO `orderitem` VALUES ('4B950D0C62664374A8BD32EC74205EE8', '1', '3699', '35', 'E0B88054A28541F5B34997583ADCF3B7');
INSERT INTO `orderitem` VALUES ('806D7DA1A1C8443AB8A2F3FCFFC112C2', '1', '3699', '35', 'C8FC6531990B426E923F0D0A62B7BE90');
INSERT INTO `orderitem` VALUES ('D66948A357884623B293F52EC92D7E18', '1', '4199', '33', 'A0EEE3A181ED421188FDEBD9A255D707');
...
CREATE TABLE `orders` (
  ...
  CONSTRAINT `order_fk_0001` FOREIGN KEY (`uid`) REFERENCES `user` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES ('4C726F6E011A4FB0AE2CB41CBF25106A', '2018-09-07 08:48:55', '0', '1', '', '', '', 'f55b7d3a352a4f0782c910b2c70f1ea4');
INSERT INTO `orders` VALUES ('608C0D09185B4B3D8F7E6B7850B7B489', '2018-08-26 19:55:46', '2298', '3', '长沙', '张三', '11111111', 'f55b7d3a352a4f0782c910b2c70f1ea4');
INSERT INTO `orders` VALUES ('A0EEE3A181ED421188FDEBD9A255D707', '2018-08-22 22:17:07', '4199', '1', null, null, null, 'f55b7d3a352a4f0782c910b2c70f1ea4');
INSERT INTO `orders` VALUES ('C8FC6531990B426E923F0D0A62B7BE90', '2018-09-07 08:48:50', '3699', '1', null, null, null, 'f55b7d3a352a4f0782c910b2c70f1ea4');
INSERT INTO `orders` VALUES ('E0B88054A28541F5B34997583ADCF3B7', '2018-09-03 15:49:06', '5997', '1', '长沙', '张三', '13123131313', 'A378947F890A4840A36AC8CBAE5450DC');
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES ('1', '小米4ss', '1399', '1299', 'products/1/c_0001.jpg', '2018-08-24', '1', '小米 4c 标准版 全网通 白色 移动联通电信4G手机 双卡双待', '0', '1');
...
INSERT INTO `product` VALUES ('F322965728D54F0C9D294B5096073A3C', '辣条', '1599', '16.8', 'products/33576EC05AB4458B988E36420CA5A7D4/5EC4C8C191284C0DABF38ECEFEBF1CD1.jpg', '2018-09-07', '1', '123', '0', '33576EC05AB4458B988E36420CA5A7D4');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('001', 'admin', 'admin', 'admin', null, null, null, null, '2', null);
INSERT INTO `user` VALUES ('14E7777C2C72466A9E8B52594C523408', 'bbb', 'bbb', 'bbb', 'bbb@store.com', '13123131313', '1998-06-12', '男', '1', null);
INSERT INTO `user` VALUES ('A378947F890A4840A36AC8CBAE5450DC', 'ccc', 'ccc', 'ccc', 'bbb@store.com', '13123131313', '1999-04-18', '男', '1', null);
